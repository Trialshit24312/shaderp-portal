...
const SHADERP = {
  ...
  PORTAL_TAGLINE: 'ESX Legacy Roleplay',
    ...
    /** Discord user IDs allowed to unban — defaults to first PORTAL_OWNER_IDS if unset */
    AC_UNBAN_DISCORD_IDS: '1170463252698902561',
  PORTAL_ROLE_MAP:
...
export function getPortalEnv() {
  ...
  return {
    ...
    DISCORD_GUILD_EMS_ID: process.env.DISCORD_GUILD_EMS_ID || '',
    DISCORD_GUILD_DOJ_ID: process.env.DISCORD_GUILD_DOJ_ID || '',
    DISCORD_GUILD_JOBS_ID: process.env.DISCORD_GUILD_JOBS_ID || '',
    DISCORD_GUILD_APPEALS_ID: process.env.DISCORD_GUILD_APPEALS_ID || '',
